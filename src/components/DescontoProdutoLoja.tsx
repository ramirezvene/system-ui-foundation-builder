...
export default function DescontoProdutoLoja() {
  ...
  return <Card className="w-full">
      ...
      <CardContent className="space-y-4">
        <TableFilter filterOptions={filterOptions} onFilterChange={handleFilterChange} onClearFilters={handleClearFilters} activeFilters={activeFilters} />
        <div className="p-0">
          ...
          <table className="w-full border-collapse table-fixed min-w-[1400px]">
            <thead>
              <tr className="border-b bg-gray-50">
                ...
                <th className="text-left p-3 w-10 text-sm font-medium">Tipo Margem</th>
                ...
                <th className="text-left p-3 w-25 text-sm font-medium">Margem</th>
                <th className="text-left p-3 w-25 text-sm font-medium">Margem Adc</th>
