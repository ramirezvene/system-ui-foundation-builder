      ...
      <CardContent className="p-0">
        <div className="w-full">
          <table className="w-full border-collapse table-fixed">
            ...
            <tbody>
              {lojas.map((loja) => (
                <tr key={loja.cod_loja} className={`border-b hover:bg-gray-50 ${editedRows.has(loja.cod_loja) ? 'bg-yellow-50' : ''}`}>
                  ...
                  <td className="p-3">
                    <div className="space-y-2">
                      <Input
                        ...
                        onChange={(e) => handleQtdeTokenChange(loja.cod_loja, parseInt(e.target.value) || 0)}
                  ...
                  <td className="p-3">
                    <Badge variant={loja.meta_loja === 1 ? "default" : "destructive"} className={
                      loja.meta_loja === 1 ? "bg-green-100 text-green-800 hover:bg-green-200 text-xs px-2" : "bg-red-100 text-red-800 hover:bg-red-200 text-xs px-2"
                    }>
                      {loja.meta_loja === 1 ? "Regular" : "Irregular"}
                    </Badge>
                  </td>
                  <td className="p-3">
                    <Badge variant={loja.dre_negativo === 1 ? "default" : "destructive"} className={
                      loja.dre_negativo === 1 ? "bg-green-100 text-green-800 hover:bg-green-200 text-xs px-2" : "bg-red-100 text-red-800 hover:bg-red-200 text-xs px-2"
                    }>
                      {loja.dre_negativo === 1 ? "Regular" : "Irregular"}
                    </Badge>
                  </td>
